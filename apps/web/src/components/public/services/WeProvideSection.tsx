    ...
    <section className="w-full bg-white px-4 py-8 sm:px-6 sm:py-12 lg:px-10 lg:py-16">
      <div className="mx-auto max-w-[1360px]">
        ...
        {/* Desktop (lg:): the tall photo is self-stretch on an items-start
            ...
            right column's bottom (matching paragraph 2 + button's row) —
            top AND bottom aligned with the component as a whole, not just
            one edge. Below lg: the tall photo (a wide sidebar treatment
            that only makes sense alongside that much vertical content) is
            dropped entirely.
