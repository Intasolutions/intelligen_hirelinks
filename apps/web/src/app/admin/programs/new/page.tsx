...
export default function NewProgramPage() {
  ...
  const onSubmit = async (data: ProgramInput) => {
    ...
    try {
      ...
      const res = await ProgramsService.createProgram(payload);
      if (res.success) {
        toast.success('Program created successfully');
        window.location.href = '/admin/programs';
      } else {
        toast.error(typeof res.error === 'string' ? res.error : res.error?.message || 'Failed to create program');
      }
    } catch (err) {
  ...
  return (
    <AdminPage 
      ...
      description="Add a new program to the platform."
      actions={
    ...
    >
      <div className="p-6">
          ...
          <form id="program-form" onSubmit={handleSubmit(onSubmit)} className="space-y-10">
            ...
            <div className="space-y-6 max-w-3xl">
              ...
              <div className="grid grid-cols-2 gap-6 pt-4 border-t border-admin-card">
                <div>
                  <ImageUploadPreview label="Primary Image" onImageChange={setPrimaryImageFile} cropTarget={CROP_TARGETS.serviceProgramPrimary} />
                  <div className="mt-4">
                ...
                <div>
                  <ImageUploadPreview label="Secondary Image" onImageChange={setSecondaryImageFile} cropTarget={CROP_TARGETS.serviceProgramSecondary} />
                  <div className="mt-4">
            ...
            <div className="space-y-6 max-w-3xl">
              ...
              <div className="p-4 bg-[#1D1D1D] border border-admin-card rounded-lg mb-6">
                <p className="text-sm text-gray-400">
                  <span className="font-semibold text-white">Note:</span> Actual reviews are dynamically injected into the public program page based on the Reviews module.
                </p>
              </div>
              ...
              <div className="flex flex-col gap-6">
                <label className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-400">Highlight this program in prime locations</div>
                  </div>
                </label>
