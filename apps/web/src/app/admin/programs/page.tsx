                  ...
                  <tr key={program._id} className="hover:bg-[#252525] transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <span className={`inline-flex items-center rounded-full px-2 py-1 text-xs font-medium ${
                        program.publishStatus === 'PUBLISHED' ? 'bg-admin-accent/10 text-admin-accent' 
                    ...
                    <td className="px-6 py-4">
                      <span className={`inline-flex items-center rounded-full px-2 py-1 text-xs font-medium ${
                        program.status === 'ACTIVE' ? 'bg-admin-accent/10 text-admin-accent' 
                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="flex items-center justify-end gap-2">
                        <Link href={`/admin/programs/${program._id}`} className="p-1 text-gray-400 hover:text-white bg-admin-card rounded transition-colors">
                          <Edit2 className="h-4 w-4" />
                        </Link>
                        <button onClick={() => handleDelete(program._id)} className="p-1 text-red-400 hover:text-red-300 bg-red-900/20 rounded transition-colors">
