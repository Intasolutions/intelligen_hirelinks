        ...
        <div className="overflow-x-auto rounded-md border border-admin-card">
          <table className="w-full text-left text-sm text-gray-300">
            ...
            <tbody className="divide-y divide-admin-card bg-admin-bg">
              {isLoading ? (
                <tr>
                  <td colSpan={6} className="px-6 py-8 text-center text-gray-400">Loading services...</td>
                </tr>
              ) : services.length === 0 ? (
                <tr>
                  <td colSpan={6} className="px-6 py-8 text-center text-gray-400">No services found.</td>
                </tr>
              ) : (
                  ...
                  <tr key={service._id} className="hover:bg-[#252525] transition-colors">
                    <td className="px-6 py-4">
                      {service.primaryImage?.url ? (
                        <img src={service.primaryImage.url} alt="Service Thumbnail" className="h-10 w-16 object-cover rounded-md border border-admin-card" />
                      ) : (
