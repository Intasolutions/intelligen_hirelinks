  ...
  if (isLoading) {
    return (
      <AdminPage title="Edit Review">
        <div className="p-8 text-center text-gray-500">Loading review...</div>
      </AdminPage>
    );
  }
              ...
              <div className="pt-4 border-t border-gray-100">
                ...
                {!removeImage && existingImage && !imageFile ? (
                  <div className="mb-2 relative inline-block">
                    <img src={existingImage} alt="Customer photo" className="h-20 w-20 object-cover rounded-full border border-gray-200" />
                    <button 
                      type="button" 
